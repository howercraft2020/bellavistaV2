    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.textSubinventory.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View arg1, int pos,
                                    long id) {
                String subinventoryCodigo = parent.getAdapter().getItem(pos).toString();
                Log.d(TAG, "subinventoryCodigo: " + subinventoryCodigo);
                if (subinventoryCodigo != null) {
                    mPresenter.getLocalizadoresBySubinventario(subinventoryCodigo);
                }
            }
        });
