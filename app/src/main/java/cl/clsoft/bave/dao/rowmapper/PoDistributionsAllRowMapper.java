...
public class PoDistributionsAllRowMapper implements RowMapper<PoDistributionsAll>{
    ...
    public PoDistributionsAll mapRow(Cursor cursor, int position) throws SQLException {
        ...
        entity.setPoDistributionId(cursor.getLong(cursor.getColumnIndex(PoDistributionsAllCatalogo.COLUMN_PO_DISTRIBUTION_ID)));
        ...
        entity.setRate(cursor.getLong(cursor.getColumnIndex(PoDistributionsAllCatalogo.COLUMN_RATE)));
        ...
        entity.setQuantityOrdered(cursor.getLong(cursor.getColumnIndex(PoDistributionsAllCatalogo.COLUMN_QUANTITY_ORDERED)));
