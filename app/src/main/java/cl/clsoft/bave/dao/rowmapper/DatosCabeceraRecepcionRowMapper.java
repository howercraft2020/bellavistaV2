...
public class DatosCabeceraRecepcionRowMapper implements RowMapper<DatosCabeceraRecepcion>
{
    public DatosCabeceraRecepcion mapRow(final Cursor cursor, final int position) throws SQLException {
        ...
        entity.setReceiptNum(Long.valueOf(cursor.getLong(cursor.getColumnIndex(DatosCabeceraRecepcionCatalogo.COLUMN_RECEIPT_NUM))));
        ...
        entity.setVendorSiteId(Long.valueOf(cursor.getLong(cursor.getColumnIndex(DatosCabeceraRecepcionCatalogo.COLUMN_VENDOR_SITE_ID))));
        ...
        entity.setOrgId(Long.valueOf(cursor.getLong(cursor.getColumnIndex(DatosCabeceraRecepcionCatalogo.COLUMN_ORG_ID))));
        return entity;
    }
}