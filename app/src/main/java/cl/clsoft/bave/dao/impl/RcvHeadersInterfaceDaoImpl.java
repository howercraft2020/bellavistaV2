...
public class RcvHeadersInterfaceDaoImpl extends GenericDao<RcvHeadersInterface> implements IRcvHeadersInterfaceDao
{
    ...
    public void update(RcvHeadersInterface rcvHeadersInterface) throws DaoException {
        ...
        values.put(RcvHeadersInterfaceCatalogo.COLUMN_VALIDATION_FLAG, rcvHeadersInterface.getValidationFlag());
        values.put(RcvHeadersInterfaceCatalogo.COLUMN_GROUP_ID, rcvHeadersInterface.getGroupId());
        super.update(RcvHeadersInterfaceCatalogo.TABLE, values, RcvHeadersInterfaceCatalogo.UPDATE, rcvHeadersInterface.getHeaderInterfaceId());
    }

    @Override
    public void delete(Long headerInterfaceId) throws DaoException {
        super.delete(RcvHeadersInterfaceCatalogo.TABLE, RcvHeadersInterfaceCatalogo.DELETE, headerInterfaceId);
    }

    public RcvHeadersInterface get(Long headerInterfaceId) throws DaoException {
        return super.selectOne(RcvHeadersInterfaceCatalogo.SELECT, new RcvHeadersInterfaceRowMapper(), headerInterfaceId);
    }
}