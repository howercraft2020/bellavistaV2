...
public class PoLinesAllCatalogo {
    ...
    public static final String TABLA = "po_lines_all";
    ...
    public static final String CREAR_TABLA = "CREATE TABLE "+ TABLA +"("+CAMPO_PO_LINE_ID_PLA+" INTEGER, "+CAMPO_PO_HEADER_ID_PLA+" INTEGER ,"+CAMPO_LINE_NUM_PLA+" TEXT, "+CAMPO_ITEM_ID_PLA+" INTEGER, "+CAMPO_ITEM_DESCRIPTION_PLA+" TEXT, "+CAMPO_UNIT_PRICE_PLA+" INTEGER, "+CAMPO_QUANTITY_PLA+" INTEGER, "+CAMPO_UNIT_MEAS_LOOKUP_CODE_PLA+" TEXT, "+CAMPO_BASE_UOM_PLA+" TEXT) ";
