...
public class DatosRecepcionCatalogo {
    ...
    public static final String SELECT = "SELECT pla.unit_meas_lookup_code, pla.item_id, pla.item_description, msi.primary_uom_code, pha.vendor_id, " +
                                        ...
                                        "pll.quantity, pll.quantity_received, pll.quantity_cancelled, pll.qty_rcv_tolerance, pha.user_id, pha.org_id "+
