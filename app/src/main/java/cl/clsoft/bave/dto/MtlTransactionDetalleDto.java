...
public class MtlTransactionDetalleDto {
    ...
    public MtlTransactionDetalleDto(){}
    ...
    public String getSubinvHasta() {
        return subinvHasta;
    }

    public void setSubinvHasta(String subinvHasta) {
        this.subinvHasta = subinvHasta;
    }

    public String getLocalHasta() {
        return localHasta;
    }

    public void setLocalHasta(String localHasta) {
